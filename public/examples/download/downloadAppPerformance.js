...
(function () {
    ...
    function downloadTest(version) {
        ...
        var downloadHttpConcurrentProgress = new window.downloadHttpConcurrentProgressPerformance(urls, 'GET', downloadCurrentRuns, downloadTestTimeout, downloadTestLength, downloadMovingAverage, downloadHttpOnComplete, downloadHttpOnProgress,
