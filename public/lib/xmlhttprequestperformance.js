...
(function() {
  ...
  */
  function xmlHttpRequestPerformance(method, url, timeout, callbackComplete, callbackProgress,callbackAbort,
   ...
   */
  xmlHttpRequestPerformance.prototype._initiateRequest = function(){
  ...
  * Execute the request
  */
    xmlHttpRequestPerformance.prototype.start = function(size, id, payload) {
  ...
  */
    xmlHttpRequestPerformance.prototype._handleLoadstart = function() {
  ...
  * Handle eror event
  */
  xmlHttpRequestPerformance.prototype._handleError = function() {
     var err = {
    ...
    /**
      ...
      */
     xmlHttpRequestPerformance.prototype._handleTimeout = function(response) {
    ...
    /**
      ...
      */
     xmlHttpRequestPerformance.prototype._handleAbort = function(response) {
  ...
  /**
    ...
    */
  xmlHttpRequestPerformance.prototype.close = function () {
      this._request.abort();
  };
   ...
   */
  xmlHttpRequestPerformance.prototype._handleOnReadyStateChange = function () {

    if(this._request.readyState === 4 && this._request.status === 200) {
              var result = {};
              result.totalTime = performance.now() - this.startTime;
              result.id = this.id;
              if(this.method==='POST'){
   ...
   * Handle the load event on the wrapped request
   */
  xmlHttpRequestPerformance.prototype._handleLoad = function (response) {
      this.totalTime = performance.now() - this.startTime;
      var result = {};
      result.time = this.totalTime;
  ...
  /**
    * Handle onProgress
    */
   xmlHttpRequestPerformance.prototype._handleOnProgressDownload = function (response) {
   ...
   /**
     * Handle onProgress
     */
   xmlHttpRequestPerformance.prototype._handleOnProgressUpload = function (response) {
       //measure bandwidth after one progress event due to rampup
...
window.xmlHttpRequestPerformance = xmlHttpRequestPerformance;
