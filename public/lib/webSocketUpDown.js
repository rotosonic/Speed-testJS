...
(function () {
     ...
     */
    function webSocketUpDown(url, callbackOnOpen, callbackOnMessage, callbackOnError) {
        this.url = url;
     ...
     */
    webSocketUpDown.prototype._initiateRequest = function () {
     ...
     * start the request
     */
    webSocketUpDown.prototype.start = function(id){
      this.id = id;
     ...
     */
    webSocketUpDown.prototype._handleOnOpen = function () {
     ...
     */
    webSocketUpDown.prototype.sendMessage = function (obj) {
     ...
     */
    webSocketUpDown.prototype._handleOnMessage = function (event) {
     ...
     */
    webSocketUpDown.prototype._handleOnError = function (event) {
     ...
     */
    webSocketUpDown.prototype._handleOnClose = function (event) {
     ...
     * close webSocket
     */
    webSocketUpDown.prototype.close = function () {
        this._request.close();
    };


    window.webSocketUpDown = webSocketUpDown;
