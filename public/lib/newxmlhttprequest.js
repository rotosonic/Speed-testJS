...
(function() {
   ...
   */
  function newxmlHttpRequest(method, url, timeout, callbackComplete, callbackProgress,callbackAbort,
   ...
   */
  newxmlHttpRequest.prototype._initiateRequest = function(){
   ...
   * Execute the request
   */
  newxmlHttpRequest.prototype.start = function(size, id, payload) {
   ...
   */
  newxmlHttpRequest.prototype._handleLoadstart = function() {
   ...
   * Handle eror event
   */
  newxmlHttpRequest.prototype._handleError = function() {
    var err = {
   ...
   */
  newxmlHttpRequest.prototype._handleTimeout = function(response) {
   ...
   */
  newxmlHttpRequest.prototype._handleAbort = function(response) {
   ...
   */
  newxmlHttpRequest.prototype.close = function () {
    this._request.abort();
  };
   ...
   */
  newxmlHttpRequest.prototype._handleOnReadyStateChange = function () {
   ...
   * Handle the load event on the wrapped request
   */
  newxmlHttpRequest.prototype._handleLoad = function (response) {
   ...
   * Handle onProgress
   */
  newxmlHttpRequest.prototype._handleOnProgressDownload = function (response) {
  ...
  window.newxmlHttpRequest = newxmlHttpRequest;
