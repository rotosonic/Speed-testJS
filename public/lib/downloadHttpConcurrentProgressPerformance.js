...
(function () {
     ...
     **/
    function downloadHttpConcurrentProgressPerformance(urls,  type, concurrentRuns, timeout, testLength, movingAverage, callbackComplete, callbackProgress, callbackAbort,
     ...
     * @return error object
     */
    downloadHttpConcurrentProgressPerformance.prototype.onTestError = function (result) {
        if (this._running) {
     ...
     * @return abort object
     */
    downloadHttpConcurrentProgressPerformance.prototype.onTestAbort = function (result) {
     ...
     */
    downloadHttpConcurrentProgressPerformance.prototype.onTestTimeout = function () {
        if(this._running) {
     ...
     * onComplete method
     */
    downloadHttpConcurrentProgressPerformance.prototype.onTestComplete = function (result) {
     ...
     * onProgress method
     */
    downloadHttpConcurrentProgressPerformance.prototype.onTestProgress = function (result) {
        if (!this._running) {
            return;
        }
        this.totalBytes = this.totalBytes + result.loaded;
     ...
     * Start the test
     */
    downloadHttpConcurrentProgressPerformance.prototype.start = function () {
      if (!this._running) {
            return;
      }
            ...
            for (var g = 1; g <= this.concurrentRuns; g++) {
                this._testIndex++;
                var request = new window.xmlHttpRequestPerformance('GET', this.urls[g]+ this.size +  '&r=' + Math.random(), this.timeout, this.onTestComplete.bind(this), this.onTestProgress.bind(this),
     ...
     * Cancel the test
     */
    downloadHttpConcurrentProgressPerformance.prototype.abortAll = function () {
        clearInterval(this.interval);
     ...
     * @private
     */
    downloadHttpConcurrentProgressPerformance.prototype._storeResults = function (result) {
     ...
     * Monitor testSeries
     */
    downloadHttpConcurrentProgressPerformance.prototype._monitor = function () {
        ...
        if (this.results.length > 0) {
            for (var i = 0; i < this.results.length; i++) {
                ...
                if (this.results[i].timeStamp > (performance.now() - (this.monitorInterval))) {
     ...
     */
    downloadHttpConcurrentProgressPerformance.prototype.initiateTest = function(){
        this._testIndex = 0;
    ...
    window.downloadHttpConcurrentProgressPerformance = downloadHttpConcurrentProgressPerformance;
})();
